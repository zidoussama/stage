              ...
              >
                ...
                <div className="absolute top-3 right-3 flex items-center gap-1 text-sm">
                  <button 
                    ...
                    className={`hover:text-pink-600 cursor-pointer transition-colors ${likesData.liked ? 'text-pink-500' : 'text-gray-400'}`}
                  >
                    <FaHeart />
                  </button>
                  <span className="text-gray-400">({likesData.count})</span>
                </div>
                ...
                {/* Add to Bag */}
                <button className="mt-auto w-full py-2 bg-black text-white text-xs rounded-full opacity-0 group-hover:opacity-100 transition duration-300" onClick={(e) => {
                  e.stopPropagation();
