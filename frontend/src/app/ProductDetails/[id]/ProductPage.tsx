...
const ProductPage: React.FC<ProductPageProps> = ({ productId }) => {
  ...
  // Calculate discounted price if product.state === 'sale' or product.discount > 0
      ...
      <main className="container mx-auto px-4 pt-8 lg:px-8 lg:pt-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col">
            ...
            {/* Static rating, reviews and sales for now */}
            ...
            <div className="mt-6 flex justify-between bg-gray-50 p-3 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <button className="px-4 py-1.5 bg-white border rounded text-sm">
                  {product.size || '90 ml'}
                </button>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="mt-6">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-pink-600">Promo!</h3>
              </div>
              <p className="text-sm text-gray-700 mt-2">
                Achetez deux et obtenez une remise de 30%
              </p>
            </div>
            ...
            <div className="mt-6 flex items-center gap-4">
              <div className="flex items-center border rounded">
                <button className="px-3 py-1 border-r text-gray-600"><FiMinus /></button>
                <input
                  type="number"
                  ...
                  readOnly
                />
                <button className="px-3 py-1 border-l text-gray-600"><FiPlus /></button>
              </div>
              <button onClick={() => {handleAddToBag(product)}} className="btn-primary flex justify-center items-center gap-2 bg-pink-600 rounded-full w-52 h-10 text-sm text-white text-center">
            ...
            <div className="mt-6 flex items-center gap-2 text-sm text-gray-500">
              <FiCopy />
              <span>Code promo: <strong>WANDERLUST</strong></span>
            </div>
          </div>
        </div>
